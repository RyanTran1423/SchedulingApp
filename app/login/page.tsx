          ...
          <form action={login} className="flex flex-col gap-4">
            ...
            <div className={`${inter.className} mt-5 flex flex-col gap-1`}>
              ...
              <input
                ...
                className="h-10 w-full border border-black bg-white px-3 pr-16 text-black"
              />

              <button 
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-147 top-[64%] -translate-y-1/2 text-sm text-purple-500 hover:text-purple-700 cursor-pointer"
              >
